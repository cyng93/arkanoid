...
class MLPlay:
    def __init__(self):
        ...
        #with open(os.path.join(os.path.dirname(__file__),'save','SVCmodel.pickle'), 'rb') as f:
        with open(os.path.join(os.path.dirname(__file__),'save','KNNmodel.pickle'), 'rb') as f:
